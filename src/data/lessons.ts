...
export const knowledgeCategories: KnowledgeCategory[] = [
  ...
  { id: 'llm-principles', name: 'LLM 原理', path: '/llm-principles', status: 'ready', intro: '从向量到 Transformer 的大模型原理体系。本分类循「先给朴素方案、再发现不足、迭代改好」的路径，把向量、神经网络、注意力机制与预训练范式逐一手把手逼出来，最终看懂 ChatGPT 是怎么长成的。', officialUrl: 'https://www.xuanyuancode.com/ai-llm' },
